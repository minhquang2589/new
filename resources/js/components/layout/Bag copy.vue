            ...
            <div class="product-card w-full rounded-lg">
                <div class="group rounded-xl relative block overflow-hidden">
                    <span
                        ...
                        class="rounded-full absolute z-10 right-2 top-2 text-white bg-red-600 px-1 lg:px-1.5 lg:py-0.5 text-xs font-medium"
                    >
                        - {{ product.discount }} %
                    </span>
                    ...
                    <div>
                        <img
                            ...
                            :alt="product.name"
                            class="primage rounded-t-2xl object-cover transition group-hover:scale-105"
                        />
                    </div>
