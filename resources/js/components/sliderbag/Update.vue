<template>
    <Dashboard page-title="Slider bag - Update">
                ...
                >
                    ...
                    >
                        <tr>
                            ...
                            <td>
                                <button
                                    @click="deleteSliderBag(value.id)"
                                    type="button"
...
export default {
    ...
    methods: {
        ...
        async fetchDataSection() {
            try {
                const response = await axios.get("/api/slider-bag/view");
                 console.log(response.data);
                if (response.data.success == true) {
                    this.dataSliderBag = response.data.data;
                } else {
